/*
 * Sum reduction operation using value sharing between processes.
 * Communication between processes to be done using blocking send and recv.
 *
 * compile: mpicxx non_blocking_sum.cc
